...
},{"babel-runtime/core-js/object/define-property":6,"whatwg-fetch":45}],3:[function(require,module,exports){
"use strict";
...
module.exports = exports["default"];
},{"./fetch":2,"./jsonrpc":4,"babel-runtime/core-js/object/define-property":6,"babel-runtime/core-js/promise":7,"babel-runtime/helpers/class-call-check":8,"babel-runtime/helpers/create-class":9,"babel-runtime/helpers/interop-require-default":10,"babel-runtime/helpers/to-consumable-array":11,"lodash":44}],4:[function(require,module,exports){
...
},{"../../modules/$":27,"../../modules/es6.array.from":38,"../../modules/es6.string.iterator":42}],13:[function(require,module,exports){
var $ = require('../../modules/$');
...
},{"../modules/$":27,"../modules/es6.object.to-string":40,"../modules/es6.promise":41,"../modules/es6.string.iterator":42,"../modules/web.dom.iterable":43}],15:[function(require,module,exports){
var $ = require('./$');
...
module.exports = cof;
},{"./$":27,"./$.wks":37}],17:[function(require,module,exports){
...
},{"./$":27,"./$.cof":16,"./$.def":18,"./$.iter":26,"./$.redef":29,"./$.wks":37}],25:[function(require,module,exports){
...
},{"./$.wks":37}],26:[function(require,module,exports){
'use strict';
var $                 = require('./$')
  , cof               = require('./$.cof')
...
},{"./$":27,"./$.assert":15,"./$.cof":16,"./$.shared":31,"./$.wks":37}],27:[function(require,module,exports){
'use strict';
...
},{"./$":27,"./$.wks":37}],33:[function(require,module,exports){
// true  -> String#at
...
},{"./$":27}],34:[function(require,module,exports){
'use strict';
var $      = require('./$')
  , ctx    = require('./$.ctx')
  , cof    = require('./$.cof')
...
},{"./$":27,"./$.cof":16,"./$.ctx":17,"./$.dom-create":19,"./$.invoke":22}],35:[function(require,module,exports){
var sid = 0;
function uid(key){
...
},{"./$":27,"./$.wks":37}],37:[function(require,module,exports){
...
},{"./$":27,"./$.shared":31,"./$.uid":35}],38:[function(require,module,exports){
var $     = require('./$')
  , ctx   = require('./$.ctx')
  , $def  = require('./$.def')
  , $iter = require('./$.iter')
...
},{"./$":27,"./$.ctx":17,"./$.def":18,"./$.iter":26,"./$.iter-call":23,"./$.iter-detect":25}],39:[function(require,module,exports){
var $          = require('./$')
...
setUnscope('values');
setUnscope('entries');
},{"./$":27,"./$.iter":26,"./$.iter-define":24,"./$.uid":35,"./$.unscope":36}],40:[function(require,module,exports){
'use strict';
...
},{"./$":27,"./$.cof":16,"./$.redef":29,"./$.wks":37}],41:[function(require,module,exports){
'use strict';
var $        = require('./$')
  , ctx      = require('./$.ctx')
  , cof      = require('./$.cof')
...
},{"./$":27,"./$.assert":15,"./$.cof":16,"./$.ctx":17,"./$.def":18,"./$.for-of":20,"./$.iter-detect":25,"./$.mix":28,"./$.set-proto":30,"./$.species":32,"./$.task":34,"./$.uid":35,"./$.wks":37}],42:[function(require,module,exports){
var set   = require('./$').set
...
},{"./$":27,"./$.iter":26,"./$.iter-define":24,"./$.string-at":33,"./$.uid":35}],43:[function(require,module,exports){
...
},{"./$":27,"./$.iter":26,"./$.wks":37,"./es6.array.iterator":39}],44:[function(require,module,exports){
(function (global){
/**
 * @license
